...
update_order_status_view, export_data_view, retry_payment_view, cancel_order_view
...
urlpatterns = [
    ...
    path('meus-pedidos/<uuid:pk>/pagar/', retry_payment_view, name='retry-payment'),
    path('meus-pedidos/<uuid:pk>/cancelar/', cancel_order_view, name='cancel-order'),
